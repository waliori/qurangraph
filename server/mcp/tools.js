...
export function buildTools({ invoke }) {
  ...
  const root_dossier = {
    ...
    description:
      ...
      + "· opposites — the curated antithesis (طباق) pairs, with attesting āyāt. ALL curated pairs, "
      + "whether or not the āya draws them into an antithesis construction\n"
  ...
  const analyze_verse = {
    ...
    description:
      ...
      + "· antithesis — curated طباق pairs FRAMED here: the āya sets the two against each other in an "
      + "antithesis construction. Narrower than `root_dossier`'s `opposites`, which lists a pair on the "
      + "strength of mere co-occurrence too — so this can be empty for an āya that dossier cites\n"
