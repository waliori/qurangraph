...
// Lexical relations { note, byRoot:{root:[{other,polarity,relatedness,contrast,seed,verses}]}, catalogue }.
// Opposition (طباق) + affinity, precomputed offline. Optional: resolves to null if absent.
